...
export default function ServicesSection() {
  const services = [
    ...
    },
    {
      ...
      description: 'Création de flyers professionnels rectangulaires verticaux 148mm x 210mm sur papier brillant 130g, recto-verso couleur avec réalisation de maquette numérique.',
      features: ['Format 148mm x 210mm', 'Papier brillant 130 grammes', 'Recto-verso couleur', 'Maquette numérique incluse', 'À partir de 290€']
    },
    {
